...
const appointmentComplete = async (req, res) => {
    try {
        ...
        const docId = req.doctorId; // 🔐 securely from middleware
        ...
        if (appointmentData.docId?.toString() === docId.toString()) {
            ...
            return res.json({
                success: false,
                message: "Mark failed. Doctor does not match appointment.",
            });
        }
    } catch (error) {
        console.log(error);
...
const appointmentCancel = async (req, res) => {
    try {
        ...
        if (appointmentData.docId?.toString() === docId.toString()) {
            ...
            return res.json({
                success: false,
                message: "Cancellation failed. Doctor does not match appointment.",
            });
        }
    } catch (error) {
        console.log(error);
...
// Api to update the doctor profiledata from doctor panel
